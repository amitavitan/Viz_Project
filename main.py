...
with row6_1:
    ...
    world_fig.update_layout(autosize=True, margin=dict(l=10, r=10, t=30, b=30), plot_bgcolor="rgba(0,0,0,0)", legend=dict(
        # yanchor="top",
        y=0,
        x = 1,
        # xanchor="left",
...
with row_6_2:
    ...
    st.markdown("On the map in the right you can see ")
st.markdown("""---""")
...
with row5_2:
    ...
    fig_trend.add_trace(
        go.Scatter(x=df_selection[col1], y=trend_line, mode="lines", name="Trend Line", marker_color="black", marker_line_width=10))
